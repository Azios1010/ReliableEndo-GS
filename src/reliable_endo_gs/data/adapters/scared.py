"""SCARED dataset identity and validation scaffold."""
...
class ScaredAdapter:
    """SCARED adapter scaffold with no assumed internal layout."""
    ...
    def enumerate_sequences(self, root: Path) -> Sequence[str]:
        raise NotImplementedError("SCARED sequence layout has not been authoritatively verified")

    def inspect_metadata(self, root: Path, sequence_id: str) -> Mapping[str, object]:
        raise NotImplementedError("SCARED metadata layout has not been authoritatively verified")
